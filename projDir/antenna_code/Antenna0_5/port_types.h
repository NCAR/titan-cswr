...
//#include <sys/types.h>
#define __linux	1		// Assume broadest coverage of types.  MGEN is RedHat Linux OS.
...
#if defined(IRIX5) || defined(SUNOS4) || defined(SUNOS5) || defined(SUNOS5_ETG) || defined(AIX) || defined(HPUX) || defined(ULTRIX) 
...
#if defined(IRIX6) || defined(DECOSF1) || defined(SUNOS5_64) || defined(SUNOS5_ETG) || defined(LINUX_ALPHA) || defined(__linux) || defined(SUNOS5_INTEL) || defined(DARWIN) || defined(CYGWIN)
typedef signed char	si08;
typedef unsigned char	ui08;
typedef signed short	si16;
typedef unsigned short	ui16;
