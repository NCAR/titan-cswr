...
#define NAN (float)0x7f800000	// signaling NAN, http://en.wikipedia.org/wiki/NaN
...
#define IWRF_MISSING_FLOAT -9999 /**< Missing val for float values */
...
#define IWRF_XMIT_SAMPLE_ID 0x77770007 /**< ID for transmit sample packet */
...
typedef enum iwrf_pulse_polarization {
  ...
  IWRF_PULSE_POL_NOT_SET = 0,
  IWRF_PULSE_POL_H = 1, /**< H pulse */
  IWRF_PULSE_POL_V = 2, /**< V pulse */
  IWRF_PULSE_POL_SLANT45 = 3, /**< Slant-45 */
...
typedef struct iwrf_packet_info {
  ...
  si32 len_bytes; /**< length of packet structure, in bytes,
		   ** except for pulse_header, in which
		   ** len_bytes = lIength of structure, plus following data */
 ...
 *
 *   <br>IWRF_SYNC_VAL_00  = 0x2a2a2a2a
 *   <br>IWRF_SYNC_VAL_01  = 0x7e7e7e7e
 *
 ************************************************************************/
...

{
  ...
  fl32 unused[460]; /**< for future expansion */
...
typedef struct iwrf_ts_processing {
  ...
  fl32 unused[32]; /**< for future expansion */
...
typedef struct iwrf_calibration {
  ...
  si32 unused[71]; /**< for future expansion */ 
...
typedef struct iwrf_event_notice {
  ...
  si32 unused[9]; /**< not used - for later expansion */
...
typedef struct iwrf_xmit_info {
  ...
  fl32 unused[10]; /**< for future expansion */
...
typedef struct iwrf_rvp8_pulse_header {
  ...
  si32 unused2[24]; /**< not used - for later expansion */
